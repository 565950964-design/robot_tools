...
* Error: 
$$
\mathbf{e}_{local} = \log_{6}(\mathbf{T}_{current}^{-1} \mathbf{T}_{des})
$$
...
* Error: 
$$
\mathbf{e}_{world} = \text{Ad}_{\mathbf{T}_{current}} \cdot \mathbf{e}_{local}
$$
  
* Jacobian: 
$$
\mathbf{J}_{world} = \text{Ad}_{\mathbf{T}_{current}} \cdot \mathbf{J}_{local}
$$
